              ...
              <table class="table table-hover text-nowrap">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="text-success">
                        <i class="fas fa-caret-up me-1"></i><span>15,704,845.02Rp</span>
                      </span>
                    </td>
                    <td>
                      <span class="text-danger">
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between p-md-1">
                  <div class="d-flex flex-row">
                    <div class="align-self-center">
                      <h2 class="h1 mb-0 me-4">1,098,844,746.00Rp</h2>
                    </div>
                    <div>
                      <h4>Total Sales</h4>
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between p-md-1">
                  <div class="d-flex flex-row">
                    <div class="align-self-center">
                      <h2 class="h1 mb-0 me-4">517,401,000.00Rp</h2>
                    </div>
                    <div>
                      <h4>Total Cost</h4>
